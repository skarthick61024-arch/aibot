...
// Using a generic SVG props type to allow className, etc.
...
export const GeminiIcon: React.FC<IconProps> = (props) => (
    <svg
        ...
        {...props}
    >
        <path d="M12.541 2.122a1.2 1.2 0 0 0-1.082 0L2.61 7.233a1.2 1.2 0 0 0-.61 1.04v9.453a1.2 1.2 0 0 0 .61 1.04l8.849 5.111a1.2 1.2 0 0 0 1.082 0l8.849-5.11a1.2 1.2 0 0 0 .61-1.04V8.273a1.2 1.2 0 0 0-.61-1.04L12.54 2.122Z M12 3.44l7.969 4.598L12 12.637 4.031 8.039 12 3.441Zm-8.25 5.545 7.65 4.417v8.835l-7.65-4.418V8.986Zm16.5 0v8.834l-7.65 4.418V13.4l7.65-4.416Z" />
    </svg>
);
...
export const ChatBubbleIcon: React.FC<IconProps> = (props) => (
    <svg
        ...
        {...props}
    >
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.05 1.05 0 0 1-1.485 0l-3.72-3.72a2.121 2.121 0 0 1-1.98-2.193v-4.286c0-.97.616-1.813 1.5-2.097m6.75-3.686a2.25 2.25 0 0 0-2.25-2.25H6.75A2.25 2.25 0 0 0 4.5 6.75v4.5a2.25 2.25 0 0 0 2.25 2.25h3.75m.75 3.75l3.75-3.75m0 0a2.25 2.25 0 0 0 2.25-2.25V6.75a2.25 2.25 0 0 0-2.25-2.25h-3.75m-3.75 0h-3.75" />
    </svg>
);
...
export const AnimatedHamburgerIcon: React.FC<IconProps & { isOpen?: boolean }> = ({ isOpen = false, ...props }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
    ...
    >
        <path 
            ...
            d="M3 6h12M3 12h12M3 18h12" 
            className={`transition-opacity duration-300 ${isOpen ? 'opacity-60' : 'opacity-100'}`}
        />
        <path 
            strokeLinecap="round" 
            strokeLinejoin="round" 
            d="M15 8l4 4-4 4" 
            className={`transition-all duration-300 ${isOpen ? 'translate-x-1' : ''}`}
        />
    </svg>
    );
...
export const AiIcon: React.FC = () => (
    <div className="w-8 h-8 rounded-full bg-sidebar-gray flex items-center justify-center flex-shrink-0">
...
// Add this new icon to your Icons.tsx
